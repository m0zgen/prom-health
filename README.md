...
Small CLI health checker for a local Prometheus / Prom++ instance.
...
It is useful for quick local diagnostics, cron checks, systemd timers, or integration into `promppctl.sh status`.
